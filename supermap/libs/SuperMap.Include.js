(function() {
    ...
    function loadSMLibs() {
        ...
        inputScript(baseurl+'graph/Bar.js');
        inputScript(baseurl+'graph/Bar3D.js');
        inputScript(baseurl+'graph/Pie.js');
        inputScript(baseurl+'graph/Ring.js');
        inputScript(baseurl+'proj4js/lib/proj4js.js');
        loadLocalization();
        inputCSS('style.css');
        inputCSS('google.css');
    }
