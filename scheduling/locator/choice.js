 ...
 function initRefresh() {
  ...
  function initialization() {
    table.initialization('tableView', 'car/info/findPage', tableColumns, ajax, {
      ...
      parent.$('#policeCarId').val(currentRow.id);
      parent.$('#policeCarNo').val(currentRow.no);
      parent.$('#department').val(currentRow.department);
      parent.$('#policeCarType').val(currentRow.type);
