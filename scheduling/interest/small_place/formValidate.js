define(['validate', 'validation', 'localization', 'utilityForm'], function (require, exports, module) {
    ...
    function processCompleted(getFeaturesEventArgs) {
        ...
        if (getFeaturesEventArgs.result && getFeaturesEventArgs.result.features.length > 0) {
            ...
            console.log(feature.attributes.LAYER);
    ...
    function save(params) {
        seajs.use('../../app/common/ajax', function (ajax) {
            ajax.post('interest/place/save', params, function (response) {
    ...
    function update(params) {
        seajs.use('../../app/common/ajax', function (ajax) {
            ajax.post('interest/place/update', params, function (response) {
                var result = response.data;
                if(result.code <=0){
                    $.showErrorInfo(result.message);
                }else{
