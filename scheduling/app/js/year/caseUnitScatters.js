...
define(function (require, exports, module) {
	...
	function getLocalData(){
        ...
        var tempSeriesData=[];
		//饼图没有[同比、环比]
		var locaData = $.zui.store.get('caseUnitScattersYear').period;
	...
	exports.initialization = function (params, ajax, chartConfig) {
		...
		//数据拼接
		var tableData = chartConfig.loadChartAndTbale(params, chartConfig,config, 'caseUnitScattersYear', 'bar', 'caseUnitScatters');
