define(function (require, exports, module) {
        ...
        if ($.isEmptyObject(unit) || 'undefined' == unit || 0 == unit.length || '1' == unit) {
            ...
            if (-1 != $.inArray('2', params.searchParams.mode) || -1 != $.inArray('3', params.searchParams.mode)) {
                ...
                if ($.isEmptyObject(params.searchParams.category)) {
                    montTpl = require('../../tpl/month/month_office_rate.html');
                    ...
                    montTpl = require('../../tpl/month/month_office_rate_special.html');
            ...
            //本期模板
                ...
                //非专项查询
                if ($.isEmptyObject(params.searchParams.category)) {
                    montTpl = require('../../tpl/month/month_office_default.html');
                    storeKeys = ['caseAffairsCategory', 'criminalAffairs', 'criminalCaseTowHour', 'securityAffairs', 'caseUnitScatters', 'caseAffairsDistrict', 'caseAffairsMainDistrict', 'caseAffairsHeatMap'];
                } else {
                    montTpl = require('../../tpl/month/month_office_default_special.html');
                    storeKeys = ['criminalCaseTowHour', 'caseUnitScatters', 'caseAffairsTrend', 'caseAffairsDistrict', 'caseAffairsMainDistrict', 'caseAffairsHeatMap'];
                }
            }
        } else {
            ...
            if (-1 != $.inArray('2', params.searchParams.mode) || -1 != $.inArray('3', params.searchParams.mode)) {
                //非专项查询
                if ($.isEmptyObject(params.searchParams.category)) {
                    montTpl = require('../../tpl/month/month_place_rate.html');
                    storeKeys = ['caseAffairsCategory', 'criminalAffairs', 'securityAffairs', 'caseAffairsDistrict', 'caseAffairsHeatMap'];
                } else {
                    montTpl = require('../../tpl/month/month_place_rate_special.html');
                    storeKeys = ['caseAffairsCategory', 'criminalCaseTowHour', 'caseAffairsDistrict', 'caseAffairsHeatMap'];
                }
            }
            //本期模板
            else {
                console.log($.isEmptyObject(params.searchParams.category))
                //非专项查询
                if ($.isEmptyObject(params.searchParams.category)) {
                    montTpl = require('../../tpl/month/month_place_default.html');
                    storeKeys = ['caseAffairsCategory', 'criminalAffairs', 'securityAffairs', 'caseAffairsDistrict', 'caseAffairsHeatMap'];
                } else {
                    montTpl = require('../../tpl/month/month_place_default_special.html');
                    storeKeys = ['caseAffairsCategory', 'criminalCaseTowHour', 'caseAffairsDistrict', 'caseAffairsHeatMap'];
                }
            }
        }
    ...
    exports.initialization = function (params) {
        seajs.use(['../app/common/ajax', '../app/common/chartRender'], function (ajax, chartRender) {
            var prefix = 'Month';
            var requestUrl = 'case/stat/findMonth';
            var storeKeys = initMonthDepends(params);
            chartRender.loadContent(storeKeys, params, ajax, prefix, requestUrl, './js/month/');
        });
    }
})