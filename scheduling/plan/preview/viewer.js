...
PDFJS.imageResourcesPath = './images/';
  PDFJS.workerSrc = '../../dist/plugins/pdf-previewer/pdf.worker.js';
  PDFJS.cMapUrl = '../preivew/cmaps/';
...
function webViewerInitialized() {
  ...
  if (file && file.lastIndexOf('file:', 0) === 0) {
    ...
    //设置请求头
    if(!$.isEmpttyObject(window.authorization)){
      xhr.setRequestHeader('userId', window.authorization.userId);
      xhr.setRequestHeader('userToken', window.authorization.userToken);
    }
